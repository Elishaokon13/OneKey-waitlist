                    ...
                    <div className="flex items-center justify-between w-full sticky mt-[7px] lg:mt-auto mb-auto inset-x-0">
                        <div className="flex items-center flex-1 lg:flex-none pl-1">
                            <Link href="/" className="text-lg font-semibold text-foreground">
                                <Image src="/icons/logo.png" alt="Blink Protocol Logo" width={30} height={30} />
                            </Link>
                        ...
                        <div className="items-center flex gap-2 lg:gap-4">
                            <Button size="sm" variant="tertiary" asChild className="hover:translate-y-0 hover:scale-100 bg-[#10b981]">
                                <Link href="#">
                                    Launch App
                                </Link>
                            </Button>
