    ...
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <Container delay={0.1}>
                ...
                Execute trades with lightning speed and ZeroGas fees from any chain and country without using VPNs.
                </p>
            </Container>
            <Container delay={0.2}>
                <div className="flex items-center justify-center md:gap-x-6 mt-8">
                    <Button asChild size="lg" className="bg-[#d000f9]">
                        <Link href="#">
                            Launch App
                        </Link>
                    </Button>
